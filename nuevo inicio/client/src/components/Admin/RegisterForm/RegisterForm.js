...
export default function RegisterForm(){
    ...
    return (
        <Form className="register-form" onSubmitCapture={register} onChange={changeForm}>
            <Form.Item>
                <Input
                prefix={<Icon component={UserOutlined } style={{color: "rgba(0,0,0,.25"}} />}
                type="email"
                name="email"
            ...
            <Form.Item>
                <Input
                prefix={<Icon component={LockOutlined } style={{color: "rgba(0,0,0,.25"}} />}
                type="password"
                name="password"
            ...
            <Form.Item>
                <Button htmlType="submitCapture" className="register-form__button">
                    Crear cuenta
                </Button>
            </Form.Item>
        </Form>
